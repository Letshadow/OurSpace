...
// let btn_all= document.getElementById("btn_all");//boton all
// let Lcat= document.getElementById("Nav_TEM");//Lista categorias
// let arrcat={IDENTY:"TEM"};
// let Ltam= document.getElementById("Nav_HAB");//Lista tamaños
// let arrtam={IDENTY:"HAB"};
